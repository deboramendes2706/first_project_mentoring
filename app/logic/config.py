...
NORMALIZADOR_PARENT_SALARY = './app/logic/data/normalizador_parent_salary_standardscaler.pkl'

NORMALIZADOR_AVERAGE_GRADES = './app/logic/data/normalizador_average_grades_standardscaler.pkl' 
